...
def grafico_FDC_semplice(x):
    ...
    plt.grid()
    plt.savefig('/var/www/wpsoutputs/CDP.png')
...
def figura_FDC_due_assi(x):
    ...
    #fig.show()
    # Save the figure
    plt.savefig('/var/www/wpsoutputs/CDP_doppio_asse.png', bbox_inches='tight', pad_inches=0.02, dpi=150)
    plt.show()
    return fig
...
def figura_dominio_burr(LCV,LCA):
    ...
    #plt.show()
    plt.savefig('/var/www/wpsoutputs/dominio_Burr.png', bbox_inches='tight', pad_inches=0.02, dpi=150)
    return fig
